    ...
    <div className="px-5 sm:px-10 lg:px-20 mt-10 bg-#2B2E31">
      <div className="mt-5 sm:mt-10 h-auto w-full mx-auto">
        <img
          ...
          src="https://wallpapercave.com/wp/wp5991219.jpg"
          alt="Defense Image"
        />
      </div>
        ...
        {[
          {
            ...
            link: "https://indianairforce.nic.in/career-in-iaf//",
          },
        ].map((item, index) => (
          <div
            key={index}
...
export default JoinButtonAirforce;
